...
function parseString(raw) { //-- Function converstion partial complete 25-Dec-2016 HY
...
function PingReply(s: string) { //-- Function converstion completed 25-Dec-2016 HY
    IRCSend("PONG " + s);
}
